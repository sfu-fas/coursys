"""
So, this is FastFixtureTestCase from django-nose, but altered to mock out
transaction.Atomic to make it work with Django 1.6

Most of the new magic is powered by Mock, and in the __call__ method. 

Mock doesn't do well at mocking out @decorators, AFAICT. 
"""
...
class DisabledFastFixtureTestCase(test.TransactionTestCase):
