...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DiscussionTopic.slug'
        db.add_column('discuss_discussiontopic', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='', unique_with=(), max_length=50, populate_from=None),
                      keep_default=False)


        # Adding field 'DiscussionMessage.slug'
        db.add_column('discuss_discussionmessage', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='', unique_with=(), max_length=50, populate_from=None),
                      keep_default=False)
            

    def backwards(self, orm):
        # Deleting field 'DiscussionTopic.slug'
        db.delete_column('discuss_discussiontopic', 'slug')

        # Deleting field 'DiscussionMessage.slug'
        db.delete_column('discuss_discussionmessage', 'slug')
