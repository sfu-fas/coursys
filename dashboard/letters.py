...
class YellowFormTenure(YellowForm):
    ...
    def draw_form(self, careerevent, person):
        ...
        self.hline(0, 239.5, 42)
        self.label(0, 235, 'Surname:')
        self.label(81, 235, 'Given:')
        self.label(144, 235, 'Preferred:')
        self.hline(16, 234.5, 71)
        self.hline(90, 234.5, 139)
        self.hline(158, 234.5, x_max)
        ...
        self.hline(30, 228.5, 32)
        self.hline(38, 228.5, 40)
        self.hline(107, 226.5, 117)
        self.hline(124, 226.5, 133)
        self.hline(140, 226.5, 147)
        ...
        self.hline(38, 213.5, x_max)
        self.label(0, 208, 'Mailing Address:')
        self.hline(38, 207.5, x_max)
        self.label(0, 203, 'Telephone:')
        self.label(83, 203, 'HOUSEHOLD moved from:')
        self.hline(33, 204.5, 35)
        self.hline(20, 202.5, 76)
        self.hline(121, 202.5, x_max)
        ...
        self.hline(3, 191.5, 22)
        self.hline(25, 191.5, 47)
        self.hline(75, 191.5, 119)
        self.hline(153, 191.5, 181.5)
        ...
        self.hline(2, 181.5, 23.5)
        self.hline(25, 181.5, 47.5)
        self.hline(49, 181.5, 145)
        self.hline(174, 181.5, 187)
        ...
        self.hline(2, 176, 23.5)
        self.hline(25, 176, 47.5)
        self.hline(49, 176, 145)
        self.hline(174, 176, 187)
        self.checkbox(153.5, 176)
        self.checkbox(162.5, 176)
        self.label(147, 171, 'Yes')
        self.label(157, 171, 'No')
        self.label(170, 171, 'by')
        self.hline(2, 170.5, 23.5)
        self.hline(25, 170.5, 47.5)
        self.hline(49, 170.5, 145)
        self.hline(174, 170.5, 187)
        ...
        self.hline(27, 161.5, 131)
        self.hline(147, 161.5, x_max)
        self.label(0, 156, 'Institution:')
        self.hline(27, 155.5, x_max)
        ...
        self.hline(74, 148.5, 139)
        self.hline(153, 148, x_max)
        ...
        self.hline(123, 141, x_max)

        self.label(0, 136, 'Previous position #:')
        self.hline(32, 135, 82)
        self.hline(88, 135, x_max)

        self.hdouble_line(0, 131.5, x_max)
        ...
        self.hline(24, 121.5, 98)
        self.hline(114, 121.5, x_max)
        ...
        self.hline(22, 115, 31.5)
        self.hline(36.5, 115, 43)
        self.hline(49, 115, 57)
        self.hline(79, 115, 88.5)
        self.hline(93, 115, 100)
        self.hline(106, 115, 114)
        self.hline(180, 115, x_max)
        ...
        self.hline(43, 107, 52)
        self.checkbox(112, 107)
        self.hline(150, 107, 161)
        self.hline(172.5, 107, 183.5)
        self.hline(150, 103.5, 161)
        self.hline(172.5, 103.5, 183.5)

        self.label(0, 100, 'Rank:')
        self.label(37, 100, 'Step:')
        self.label(81, 100, 'Market Dif:  $')
        self.label(131.5, 100, 'Start-up:  $')
        self.hline(9.5, 99.5, 35)
        self.hline(44.5, 99.5, 79.5)
        self.hline(99.5, 99.5, 130)
        self.hline(148, 99.5, 182)
        ...
        self.hdouble_line(0, 64.5, x_max)

        # Approval
        self.header_label(0, 60.5, 'APPROVED BY:')
        self.hline(0, 60, 24.5)
        self.label(0.5, 55, 'Chair/Director:')
        self.label(136, 55, 'Date:')
        self.hline(38.5, 54.5, 130)
        self.hline(144, 54.5, x_max)
        self.label(0.5, 49, 'Dean of Faculty:')
        self.label(136, 49, 'Date:')
        self.hline(38.5, 48.5, 130)
        self.hline(144, 48.5, x_max)
        self.label(0.5, 43, 'Vice President Academic:')
        self.label(136, 43, 'Date:')
        self.hline(38.5, 42.5, 130)
        self.hline(144, 42.5, x_max)
        self.label(0.5, 37, 'President:')
        self.label(136, 37, 'Date:')
        self.hline(38.5, 36.5, 130)
        self.hline(144, 36.5, x_max)

        self.hdouble_line(0, 34, x_max)
