...
class YellowFormTenure(YellowForm):
    ...
    def draw_form(self, careerevent, person):
        ...
        self.c.line(0, 60*mm, 24.5*mm, 60*mm)
        self.label(0.5, 55, 'Chair/Director:')
        self.label(136, 55, 'Date:')
        self.c.line(38.5*mm, 54.5*mm, 130*mm, 54.5*mm)
        self.c.line(144*mm, 54.5*mm, 190*mm, 54.5*mm)
        self.label(0.5, 49, 'Dean of Faculty:')
        self.label(136, 49, 'Date:')
        self.c.line(38.5*mm, 48.5*mm, 130*mm, 48.5*mm)
        self.c.line(144*mm, 48.5*mm, 190*mm, 48.5*mm)
        self.label(0.5, 43, 'Vice President Academic:')
        self.label(136, 43, 'Date:')
        self.c.line(38.5*mm, 42.5*mm, 130*mm, 42.5*mm)
        self.c.line(144*mm, 42.5*mm, 190*mm, 42.5*mm)
        self.label(0.5, 37, 'President:')
        self.label(136, 37, 'Date:')
        self.c.line(38.5*mm, 36.5*mm, 130*mm, 36.5*mm)
        self.c.line(144*mm, 36.5*mm, 190*mm, 36.5*mm)

        self.double_line(0, 34, 190, 34)
        ...
        self.c.line(27.5*mm, 22.2*mm, 53*mm, 22.2*mm)
        ...
        self.c.line(27.5*mm, 18.5*mm, 53*mm, 18.5*mm)
        self.checkbox(85.5, 18.5)
        self.label(0, 14.5, '3. Salary/Base')
        self.c.line(27.5*mm, 13*mm, 53*mm, 13*mm)
        self.label(0, 10, '4. Date of scale')
        self.c.line(27.5*mm, 9*mm, 53*mm, 9*mm)
        ...
        self.c.line(123.5*mm, 9*mm, 133*mm, 9*mm)
        self.c.line(142.5*mm, 9*mm, 167.5*mm, 9*mm)
        self.header_label(73, 5, '+')
        self.label(76, 5, 'base')
        self.header_label(101.5, 5, '=')
        self.label(104, 5, 'Maximum $')
        self.c.line(82.5*mm, 4.2*mm, 101*mm, 4.2*mm)
        self.c.line(122*mm, 4.2*mm, 153.5*mm, 4.2*mm)
        self.header_label(62, 0, 'or')
        self.label(67, 0, 'c) Reimbursement outside North America')
        self.label(139, 0, 'Amount $')
        self.c.line(153*mm, -0.5*mm, x_max, -0.5*mm)
        self.c.showPage()
