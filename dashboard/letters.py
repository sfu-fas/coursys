...
class YellowFormTenure(YellowForm):
    ...
    def draw_form(self, careerevent):
        ...
        self.label_filled(2, 182, event.config.get('degree1'))
        self.hline(25, 47.5, 181.5)
        self.label_filled(32, 182, event.config.get('year1'))
        ...
        self.label_filled(2, 176.5, event.config.get('degree2'))
        self.label_filled(32, 176.5, event.config.get('year2'))
        ...
        self.label_filled(2, 171, event.config.get('degree3'))
        self.label_filled(32, 171, event.config.get('year3'))
...
class YellowFormLimited(YellowForm):
    ...
    def draw_form(self, careerevent):
        ...
        self.label_filled(2, 176.5, event.config.get('degree1'))
        self.label_filled(32, 176.5, event.config.get('year1'))
        ...
        self.label_filled(2, 171, event.config.get('degree2'))
        self.label_filled(32, 171, event.config.get('year2'))
        ...
        self.label_filled(2, 165.5, event.config.get('degree3'))
        self.label_filled(32, 165.5, event.config.get('year3'))
