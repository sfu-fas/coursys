...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dashboard_signature', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coredata.Person'])),
            ('sig', self.gf('django.db.models.fields.files.ImageField')(max_length=500)),
        ))
        db.send_create_signal('dashboard', ['Signature'])


    def backwards(self, orm):
        
        # Deleting model 'Signature'
        db.delete_table('dashboard_signature')
    ...
    models = {
        ...
        'dashboard.signature': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sig': ('django.db.models.fields.files.ImageField', [], {'max_length': '500'}),
