...
def edit_courses(request, semester, plan_slug):
    ...
    MeetingTimeFormSet = inlineformset_factory(PlannedOffering, MeetingTime, extra=3)
    ...
    return render_to_response("planning/edit_courses.html",
        {'form': form, 'formset': formset, 'plan': plan, 'offerings_list': offerings_list},
