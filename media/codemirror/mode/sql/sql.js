...
(function() {
  ...
  var sqlKeywords = "alter and as asc between by count create delete desc distinct drop from fetch first rows having in insert into is join like not on or order select set table union update values where ";
