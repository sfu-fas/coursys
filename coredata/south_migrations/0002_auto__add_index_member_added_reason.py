...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Member', fields ['added_reason']
        db.create_index(u'coredata_member', ['added_reason'])


    def backwards(self, orm):
        # Removing index on 'Member', fields ['added_reason']
        db.delete_index(u'coredata_member', ['added_reason'])
