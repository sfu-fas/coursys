...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Member.labtut_section'
        db.add_column('coredata_member', 'labtut_section', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Member.labtut_section'
        db.delete_column('coredata_member', 'labtut_section')
