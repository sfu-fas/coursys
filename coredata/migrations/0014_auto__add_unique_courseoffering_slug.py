...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'CourseOffering', fields ['slug']
        db.create_unique('coredata_courseoffering', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CourseOffering', fields ['slug']
        db.delete_unique('coredata_courseoffering', ['slug'])
