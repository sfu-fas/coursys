...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Role.department'
        db.add_column('coredata_role', 'department', self.gf('django.db.models.fields.CharField')(default='CMPT', max_length=4), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Role.department'
        db.delete_column('coredata_role', 'department')
