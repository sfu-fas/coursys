...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CourseOffering.search_text'
        db.add_column('coredata_courseoffering', 'search_text', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CourseOffering.search_text'
        db.delete_column('coredata_courseoffering', 'search_text')
    ...
    models = {
        'coredata.courseoffering': {
            ...
            'search_text': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
