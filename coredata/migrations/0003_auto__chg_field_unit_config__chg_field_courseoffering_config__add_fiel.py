...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'coredata_unit', 'config', self.gf('courselib.json_fields.JSONField')())

        # Changing field 'CourseOffering.config'
        db.alter_column(u'coredata_courseoffering', 'config', self.gf('courselib.json_fields.JSONField')())
        # Adding field 'Role.config'
        db.add_column(u'coredata_role', 'config',
                      self.gf('courselib.json_fields.JSONField')(default={}),
                      keep_default=False)


        # Changing field 'Person.config'
        db.alter_column(u'coredata_person', 'config', self.gf('courselib.json_fields.JSONField')())

        # Changing field 'Course.config'
        db.alter_column(u'coredata_course', 'config', self.gf('courselib.json_fields.JSONField')())

        # Changing field 'Member.config'
        db.alter_column(u'coredata_member', 'config', self.gf('courselib.json_fields.JSONField')())

    def backwards(self, orm):

        # Changing field 'Unit.config'
        db.alter_column(u'coredata_unit', 'config', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'CourseOffering.config'
        db.alter_column(u'coredata_courseoffering', 'config', self.gf('jsonfield.fields.JSONField')())
        # Deleting field 'Role.config'
        db.delete_column(u'coredata_role', 'config')


        # Changing field 'Person.config'
        db.alter_column(u'coredata_person', 'config', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Course.config'
        db.alter_column(u'coredata_course', 'config', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Member.config'
        db.alter_column(u'coredata_member', 'config', self.gf('jsonfield.fields.JSONField')())
