...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseOffering.flags'
        db.add_column('coredata_courseoffering', 'flags',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseOffering.flags'
        db.delete_column('coredata_courseoffering', 'flags')
