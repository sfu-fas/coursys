...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('coredata_nonstudent', (
            ...
            ('high_school', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('notes', self.gf('django.db.models.fields.TextField')()),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coredata.Unit'], null=True, blank=True)),
        ))
        db.send_create_signal('coredata', ['NonStudent'])


    def backwards(self, orm):
        
        # Deleting model 'NonStudent'
        db.delete_table('coredata_nonstudent')
    ...
    models = {
        ...
        'coredata.nonstudent': {
            ...
            'high_school': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
