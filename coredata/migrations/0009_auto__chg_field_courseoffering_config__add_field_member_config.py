...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Member.config'
        db.add_column('coredata_member', 'config', self.gf('jsonfield.JSONField')(default={}), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'CourseOffering.config'
        db.alter_column('coredata_courseoffering', 'config', self.gf('jsonfield.JSONField')(null=True))

        # Deleting field 'Member.config'
        db.delete_column('coredata_member', 'config')
