...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CourseOffering.url'
        db.delete_column('coredata_courseoffering', 'url')

        # Deleting field 'CourseOffering.department'
        db.delete_column('coredata_courseoffering', 'department')


    def backwards(self, orm):
        
        # Adding field 'CourseOffering.url'
        db.add_column('coredata_courseoffering', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True), keep_default=False)

        # Adding field 'CourseOffering.department'
        db.add_column('coredata_courseoffering', 'department', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True), keep_default=False)
