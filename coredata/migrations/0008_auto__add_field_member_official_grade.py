...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Member.official_grade'
        db.add_column('coredata_member', 'official_grade', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Member.official_grade'
        db.delete_column('coredata_member', 'official_grade')
