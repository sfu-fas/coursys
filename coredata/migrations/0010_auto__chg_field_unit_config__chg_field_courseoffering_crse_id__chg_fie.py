...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Unit.config'
        db.alter_column('coredata_unit', 'config', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'CourseOffering.crse_id'
        db.alter_column('coredata_courseoffering', 'crse_id', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'CourseOffering.config'
        db.alter_column('coredata_courseoffering', 'config', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'CourseOffering.class_nbr'
        db.alter_column('coredata_courseoffering', 'class_nbr', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'Person.config'
        db.alter_column('coredata_person', 'config', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Course.config'
        db.alter_column('coredata_course', 'config', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Member.config'
        db.alter_column('coredata_member', 'config', self.gf('jsonfield.fields.JSONField')())

    def backwards(self, orm):

        # Changing field 'Unit.config'
        db.alter_column('coredata_unit', 'config', self.gf('jsonfield.JSONField')())

        # User chose to not deal with backwards NULL issues for 'CourseOffering.crse_id'
        raise RuntimeError("Cannot reverse this migration. 'CourseOffering.crse_id' and its values cannot be restored.")

        # Changing field 'CourseOffering.config'
        db.alter_column('coredata_courseoffering', 'config', self.gf('jsonfield.JSONField')())

        # User chose to not deal with backwards NULL issues for 'CourseOffering.class_nbr'
        raise RuntimeError("Cannot reverse this migration. 'CourseOffering.class_nbr' and its values cannot be restored.")

        # Changing field 'Person.config'
        db.alter_column('coredata_person', 'config', self.gf('jsonfield.JSONField')())

        # Changing field 'Course.config'
        db.alter_column('coredata_course', 'config', self.gf('jsonfield.JSONField')())

        # Changing field 'Member.config'
        db.alter_column('coredata_member', 'config', self.gf('jsonfield.JSONField')())
    ...
    models = {
        ...
        'coredata.courseoffering': {
            ...
            'class_nbr': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'db_index': 'True'}),
