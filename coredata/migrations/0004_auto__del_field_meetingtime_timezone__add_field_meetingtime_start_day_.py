...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MeetingTime.timezone'
        db.delete_column('coredata_meetingtime', 'timezone')

        # Adding field 'MeetingTime.start_day'
        db.add_column('coredata_meetingtime', 'start_day', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 1, 1)), keep_default=False)

        # Adding field 'MeetingTime.end_day'
        db.add_column('coredata_meetingtime', 'end_day', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 4, 1)), keep_default=False)

        # Adding field 'MeetingTime.exam'
        db.add_column('coredata_meetingtime', 'exam', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'MeetingTime.timezone'
        db.add_column('coredata_meetingtime', 'timezone', self.gf('timezones.fields.TimeZoneField')(default='America/Vancouver', max_length=100), keep_default=False)

        # Deleting field 'MeetingTime.start_day'
        db.delete_column('coredata_meetingtime', 'start_day')

        # Deleting field 'MeetingTime.end_day'
        db.delete_column('coredata_meetingtime', 'end_day')

        # Deleting field 'MeetingTime.exam'
        db.delete_column('coredata_meetingtime', 'exam')
