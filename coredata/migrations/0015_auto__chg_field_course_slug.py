...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('coredata_course', 'slug', self.gf('autoslug.fields.AutoSlugField')(default='none', unique=True, max_length=50, populate_from=None, unique_with=()))

    def backwards(self, orm):

        # Changing field 'Course.slug'
        db.alter_column('coredata_course', 'slug', self.gf('autoslug.fields.AutoSlugField')(populate_from=None, unique=True, max_length=50, null=True, unique_with=()))
