...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseOffering.units'
        db.add_column(u'coredata_courseoffering', 'units',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseOffering.units'
        db.delete_column(u'coredata_courseoffering', 'units')
    ...
    models = {
        ...
        u'coredata.courseoffering': {
            ...
            'graded': ('django.db.models.fields.BooleanField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
