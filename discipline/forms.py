...
from discipline.models import DisciplineGroup, DisciplineCaseInstrStudent, DisciplineCaseInstrNonStudent, \
    ...
    CaseAttachment, INSTR_PENALTY_CHOICES, INSTR_PENALTY_VALUES, MAX_ATTACHMENTS_TEXT, MODE_CHOICES
...
class FactsForm(CaseEditForm):
    ...
    mode = forms.ChoiceField(choices=MODE_CHOICES, widget=forms.RadioSelect(), required=False,
