...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'CourseDescription', fields ['unit', 'description']
        db.create_unique('ta_coursedescription', ['unit_id', 'description'])


        # Changing field 'TUG.config'
        db.alter_column('ta_tug', 'config', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'TAPosting.config'
        db.alter_column('ta_taposting', 'config', self.gf('jsonfield.fields.JSONField')())

    def backwards(self, orm):
        # Removing unique constraint on 'CourseDescription', fields ['unit', 'description']
        db.delete_unique('ta_coursedescription', ['unit_id', 'description'])
        ...
        # Changing field 'TUG.config'
        db.alter_column('ta_tug', 'config', self.gf('jsonfield.JSONField')())

        # Changing field 'TAPosting.config'
        db.alter_column('ta_taposting', 'config', self.gf('jsonfield.JSONField')())
    ...
    models = {
        ...
        'ta.coursedescription': {
            'Meta': {'unique_together': "(('unit', 'description'),)", 'object_name': 'CourseDescription'},
            'config': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
