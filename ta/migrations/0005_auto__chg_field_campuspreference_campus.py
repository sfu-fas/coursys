...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CampusPreference.campus'
        db.alter_column('ta_campuspreference', 'campus', self.gf('django.db.models.fields.CharField')(max_length=5))

    def backwards(self, orm):

        # Changing field 'CampusPreference.campus'
        db.alter_column('ta_campuspreference', 'campus', self.gf('django.db.models.fields.CharField')(max_length=4))
