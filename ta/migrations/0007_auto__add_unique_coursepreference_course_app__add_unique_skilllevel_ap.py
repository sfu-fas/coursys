...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CoursePreference', fields ['course', 'app']
        db.create_unique('ta_coursepreference', ['course_id', 'app_id'])

        # Adding unique constraint on 'SkillLevel', fields ['app', 'skill']
        db.create_unique('ta_skilllevel', ['app_id', 'skill_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SkillLevel', fields ['app', 'skill']
        db.delete_unique('ta_skilllevel', ['app_id', 'skill_id'])

        # Removing unique constraint on 'CoursePreference', fields ['course', 'app']
        db.delete_unique('ta_coursepreference', ['course_id', 'app_id'])
    ...
    models = {
        ...
        'ta.coursepreference': {
            'Meta': {'unique_together': "(('app', 'course'),)", 'object_name': 'CoursePreference'},
            'app': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ta.TAApplication']"}),
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coredata.Course']"}),
        ...
        'ta.skilllevel': {
            'Meta': {'unique_together': "(('app', 'skill'),)", 'object_name': 'SkillLevel'},
            'app': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ta.TAApplication']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
