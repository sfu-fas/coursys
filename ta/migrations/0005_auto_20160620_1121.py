...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='resume',
            field=models.FileField(upload_to=ta.models._resume_upload_to, storage=django.core.files.storage.FileSystemStorage(base_url=None, location=b'submitted_files'), max_length=500, blank=True, help_text=b'Please attach your resume.', null=True),
        ),
        migrations.AddField(
            model_name='taapplication',
