...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'ArtifactNote.artifact' to match new field type.
        db.rename_column('advisornotes_artifactnote', 'artifact', 'artifact_id')
        # Changing field 'ArtifactNote.artifact'
        db.alter_column('advisornotes_artifactnote', 'artifact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['advisornotes.Artifact'], null=True))
        # Adding index on 'ArtifactNote', fields ['artifact']
        db.create_index('advisornotes_artifactnote', ['artifact_id'])


    def backwards(self, orm):
        # Removing index on 'ArtifactNote', fields ['artifact']
        db.delete_index('advisornotes_artifactnote', ['artifact_id'])
        ...
        # Renaming column for 'ArtifactNote.artifact' to match new field type.
        db.rename_column('advisornotes_artifactnote', 'artifact_id', 'artifact')
        # Changing field 'ArtifactNote.artifact'
        db.alter_column('advisornotes_artifactnote', 'artifact', self.gf('django.db.models.fields.CharField')(max_length=140, null=True))
