...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Problem.resolved_at'
        db.add_column('advisornotes_problem', 'resolved_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


        # Changing field 'Problem.status'
        db.alter_column('advisornotes_problem', 'status', self.gf('django.db.models.fields.CharField')(max_length=4))

    def backwards(self, orm):
        # Deleting field 'Problem.resolved_at'
        db.delete_column('advisornotes_problem', 'resolved_at')


        # Changing field 'Problem.status'
        db.alter_column('advisornotes_problem', 'status', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))
