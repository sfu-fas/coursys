...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('advisornotes_problem', (
            ...
            ('status', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('resolution_lasts', self.gf('django.db.models.fields.IntegerField')()),
            ('resolved_until', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coredata.Unit'])),
        ))
        db.send_create_signal('advisornotes', ['Problem'])


    def backwards(self, orm):
        # Deleting model 'Problem'
        db.delete_table('advisornotes_problem')
    ...
    models = {
        ...
        'advisornotes.problem': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coredata.Unit']"})
        },
        'coredata.course': {
