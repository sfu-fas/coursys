...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdvisorNote.emailed'
        db.add_column('advisornotes_advisornote', 'emailed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdvisorNote.emailed'
        db.delete_column('advisornotes_advisornote', 'emailed')
