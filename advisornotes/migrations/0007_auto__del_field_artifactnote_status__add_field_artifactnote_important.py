...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArtifactNote.status'
        db.delete_column('advisornotes_artifactnote', 'status')

        # Adding field 'ArtifactNote.important'
        db.add_column('advisornotes_artifactnote', 'important',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ArtifactNote.status'
        db.add_column('advisornotes_artifactnote', 'status',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ArtifactNote.important'
        db.delete_column('advisornotes_artifactnote', 'important')
