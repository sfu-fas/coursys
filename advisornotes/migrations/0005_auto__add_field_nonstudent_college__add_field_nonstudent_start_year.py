...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NonStudent.college'
        db.add_column('advisornotes_nonstudent', 'college',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NonStudent.start_year'
        db.add_column('advisornotes_nonstudent', 'start_year',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NonStudent.college'
        db.delete_column('advisornotes_nonstudent', 'college')

        # Deleting field 'NonStudent.start_year'
        db.delete_column('advisornotes_nonstudent', 'start_year')
