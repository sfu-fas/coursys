...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArtifactNote.best_before'
        db.alter_column('advisornotes_artifactnote', 'best_before', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ArtifactNote.best_before'
        raise RuntimeError("Cannot reverse this migration. 'ArtifactNote.best_before' and its values cannot be restored.")
    ...
    models = {
        ...
        'advisornotes.problem': {
            ...
            'resolution_lasts': ('django.db.models.fields.IntegerField', [], {}),
            'resolved_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'resolved_until': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'OPEN'", 'max_length': '4'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coredata.Unit']"})
        },
        'coredata.course': {
