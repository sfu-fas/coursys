...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActivityMark.activity'
        db.add_column('marking_activitymark', 'activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['grades.NumericActivity'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ActivityMark.activity'
        db.delete_column('marking_activitymark', 'activity_id')
