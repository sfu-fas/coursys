...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActivityComponent.slug'
        db.add_column('marking_activitycomponent', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=('numeric_activity',), null=True, unique=False, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ActivityComponent.slug'
        db.delete_column('marking_activitycomponent', 'slug')
    ...
    models = {
        ...
        'marking.activitycomponent': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'max_length': '50', 'unique_with': "('numeric_activity',)", 'null': 'True', 'unique': 'False', 'db_index': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
