...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Fill in an appropriate slug value"
        for ac in orm.ActivityComponent.objects.all():
            ac.slug = slugify(ac.title)
            ac.save()
    ...
    models = {
        ...
        'marking.activitycomponent': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'max_length': '50', 'unique': 'False', 'unique_with': "('numeric_activity',)", 'db_index': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
