...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CalLetterActivity.letter_cutoff_formula'
        db.delete_column('grades_calletteractivity', 'letter_cutoff_formula')

        # Adding field 'CalLetterActivity.letter_cutoffs'
        db.add_column('grades_calletteractivity', 'letter_cutoffs', self.gf('django.db.models.fields.CharField')(default='[95, 90, 85, 80, 75, 70, 65, 60, 55, 50]', max_length=500), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CalLetterActivity.letter_cutoff_formula'
        db.add_column('grades_calletteractivity', 'letter_cutoff_formula', self.gf('django.db.models.fields.CharField')(default='', max_length=250), keep_default=False)

        # Deleting field 'CalLetterActivity.letter_cutoffs'
        db.delete_column('grades_calletteractivity', 'letter_cutoffs')
