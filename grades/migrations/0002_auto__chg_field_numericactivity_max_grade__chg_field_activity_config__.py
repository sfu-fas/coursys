...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NumericActivity.max_grade'
        db.alter_column('grades_numericactivity', 'max_grade', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

        # Changing field 'Activity.config'
        db.alter_column('grades_activity', 'config', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'NumericGrade.value'
        db.alter_column('grades_numericgrade', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'NumericActivity.max_grade'
        db.alter_column('grades_numericactivity', 'max_grade', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'Activity.config'
        db.alter_column('grades_activity', 'config', self.gf('jsonfield.JSONField')())

        # Changing field 'NumericGrade.value'
        db.alter_column('grades_numericgrade', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))
