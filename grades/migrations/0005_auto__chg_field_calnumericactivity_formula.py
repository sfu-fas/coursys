...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CalNumericActivity.formula'
        db.alter_column('grades_calnumericactivity', 'formula', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'CalNumericActivity.formula'
        db.alter_column('grades_calnumericactivity', 'formula', self.gf('django.db.models.fields.CharField')(max_length=250))
