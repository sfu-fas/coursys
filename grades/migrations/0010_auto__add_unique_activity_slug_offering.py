...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Activity', fields ['slug', 'offering']
        db.create_unique('grades_activity', ['slug', 'offering_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Activity', fields ['slug', 'offering']
        db.delete_unique('grades_activity', ['slug', 'offering_id'])
