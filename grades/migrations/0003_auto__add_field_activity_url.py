...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('grades_activity', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Activity.url'
        db.delete_column('grades_activity', 'url')
