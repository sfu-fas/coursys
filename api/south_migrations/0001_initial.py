...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConsumerInfo'
        db.create_table(u'api_consumerinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('consumer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oauth_provider.Consumer'])),
            ('timestamp', self.gf('django.db.models.fields.IntegerField')(default=1411602112.559567)),
        ...
        db.send_create_signal(u'api', ['ConsumerInfo'])


    def backwards(self, orm):
        # Deleting model 'ConsumerInfo'
        db.delete_table(u'api_consumerinfo')


    models = {
        u'api.consumerinfo': {
            'Meta': {'object_name': 'ConsumerInfo'},
            ...
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1411602112.563614'})
        },
        u'auth.group': {
