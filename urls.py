...
#---------------------------------------
    ...
    url(r'^' + COURSE_ACTIVITY_SLUG + '$', 'grades.views.activity_info'),
        ...
        url(r'^m/' + COURSE_ACTIVITY_SLUG + '/search/$', 'mobile.views.student_activity_search'),
        url(r'^m/' + COURSE_ACTIVITY_SLUG + '/studentinfo/'+ USERID_SLUG +'/$', 'mobile.views.student_activity_info'),
    ...
    url(r'^' + COURSE_ACTIVITY_SLUG + '/edit_cutoffs$', 'grades.views.edit_cutoffs'),
