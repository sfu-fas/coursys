...
urlpatterns += patterns('',
    ...
    url(r'^grad/' + GRAD_SLUG + '/general$', 'grad.views.manage_academics'),
    ...
    url(r'^grad/' + GRAD_SLUG + '/scholarship$', 'grad.views.manage_scholarship'),
    url(r'^grad/' + GRAD_SLUG + '/letters$', 'grad.views.view_all_letters'),
    url(r'^grad/' + GRAD_SLUG + '/letters/new$', 'grad.views.new_letter'),
    url(r'^grad/' + GRAD_SLUG + '/letters/get_text/' + LETTER_TEMPLATE_ID + '$', 'grad.views.get_letter_text'),
    ...
    url(r'^advising/artifacts/new$', 'advisornotes.views.new_artifact_note'),
