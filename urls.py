...
#---------------------------------------
    ...
    url(r'^ta/postings/' + POST_SLUG + '/manual$', 'ta.views.new_application_manual'),
    ...
    url(r'^ta/application/update/' + APP_ID + '$', 'ta.views.update_application'),
    ...
    url(r'^ta/contracts/' + POST_SLUG + '/csv$', 'ta.views.contracts_csv'),
