...
urlpatterns += patterns('',
    ...
    url(r'^grad/' + GRAD_SLUG + '/letters/_new$', 'grad.views.new_letter'),
    ...
    url(r'^advising/courses/' + UNIT_COURSE_SLUG + '/new_note$', 'advisornotes.views.new_artifact_note'),
    ...
    url(r'^advising/offerings/' + COURSE_SLUG + '/new_note$', 'advisornotes.views.new_artifact_note'),
    ...
    url(r'^advising/artifacts/' + ARTIFACT_SLUG + '/new_note$', 'advisornotes.views.new_artifact_note'),
