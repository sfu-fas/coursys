...
#---------------------------------------
    ...
    url(r'^' + 'config/news/$', 'django.views.generic.simple.redirect_to', {'url': '/config/'}),
    ...
    #url(r'^' + 'config/calendar/$', 'dashboard.views.calendar_config'),
    url(r'^' + 'config/calendar/$', 'django.views.generic.simple.redirect_to', {'url': '/config/'}),
    ...
    url(r'^' + COURSE_SLUG + '/_config$', 'grades.views.course_url'),
