...
report_patterns = [
    ...
    url(r'^type/' + REPORT_SLUG + '/schedule/delete/(?P<schedule_rule_id>\d+)$', reports_views.delete_schedule_rule, name='delete_schedule_rule'),
    url(r'^type/' + REPORT_SLUG + '/component/new$', reports_views.new_component, name='new_component'),
    url(r'^type/' + REPORT_SLUG + '/component/delete/(?P<component_id>\d+)$', reports_views.delete_component, name='delete_component'),
    url(r'^type/' + REPORT_SLUG + '/query/new$', reports_views.new_query, name='new_query'),
    url(r'^type/' + REPORT_SLUG + '/query/edit/(?P<query_id>\d+)$', reports_views.edit_query, name='edit_query'),
    url(r'^type/' + REPORT_SLUG + '/query/delete/(?P<query_id>\d+)$', reports_views.delete_query, name='delete_query'),
