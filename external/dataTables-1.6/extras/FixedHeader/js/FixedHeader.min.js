...
var d=this;this.fnInitSettings(c,a);if(typeof b.fnSettings=="function"){if(b.fnVersionCheck("1.6.0")!==true){alert("FixedHeader 2 required DataTables 1.6.0 or later. Please upgrade your DataTables installation");
...
})},_fnCloneTLeft:function(e){var b=this.fnGetSettings();var a=e.nNode;var d=jQuery("tbody tr:eq(0) td",this.nTable).length;
...
var a=e.nNode;var d=jQuery("tbody tr:eq(0) td",this.nTable).length;while(a.childNodes.length>0){a.removeChild(a.childNodes[0])
