...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RAAppointment.lump_sum_hours'
        db.add_column('ra_raappointment', 'lump_sum_hours',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RAAppointment.lump_sum_hours'
        db.delete_column('ra_raappointment', 'lump_sum_hours')
    ...
    models = {
        ...
        'ra.raappointment': {
            ...
            'hiring_category': ('django.db.models.fields.CharField', [], {'default': "'GRA'", 'max_length': '60'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lump_sum_hours': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
