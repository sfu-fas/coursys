...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RAAppointment.deleted'
        db.add_column('ra_raappointment', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'RAAppointment.sin'
        db.alter_column('ra_raappointment', 'sin', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'RAAppointment.deleted'
        db.delete_column('ra_raappointment', 'deleted')


        # Changing field 'RAAppointment.sin'
        db.alter_column('ra_raappointment', 'sin', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
