...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RAAppointment.hiring_category'
        db.alter_column('ra_raappointment', 'hiring_category', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'RAAppointment.lump_sum_hours'
        db.alter_column('ra_raappointment', 'lump_sum_hours', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'RAAppointment.hiring_category'
        db.alter_column('ra_raappointment', 'hiring_category', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'RAAppointment.lump_sum_hours'
        db.alter_column('ra_raappointment', 'lump_sum_hours', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2))
    ...
    models = {
        ...
        'ra.raappointment': {
            ...
            'hiring_category': ('django.db.models.fields.CharField', [], {'default': "'GRA'", 'max_length': '4'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lump_sum_hours': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
