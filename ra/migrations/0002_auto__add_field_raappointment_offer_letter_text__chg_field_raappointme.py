...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RAAppointment.offer_letter_text'
        db.add_column('ra_raappointment', 'offer_letter_text',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


        # Changing field 'RAAppointment.config'
        db.alter_column('ra_raappointment', 'config', self.gf('jsonfield.fields.JSONField')())

    def backwards(self, orm):
        # Deleting field 'RAAppointment.offer_letter_text'
        db.delete_column('ra_raappointment', 'offer_letter_text')


        # Changing field 'RAAppointment.config'
        db.alter_column('ra_raappointment', 'config', self.gf('jsonfield.JSONField')())
