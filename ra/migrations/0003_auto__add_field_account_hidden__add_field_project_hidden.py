...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.hidden'
        db.add_column('ra_account', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Project.hidden'
        db.add_column('ra_project', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.hidden'
        db.delete_column('ra_account', 'hidden')

        # Deleting field 'Project.hidden'
        db.delete_column('ra_project', 'hidden')
