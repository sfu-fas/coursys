...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ra_raappointment', (
            ...
            ('sin', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('hiring_faculty', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ra_hiring_faculty', to=orm['coredata.Person'])),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coredata.Unit'])),
            ('hiring_category', self.gf('django.db.models.fields.CharField')(default='GRA', max_length=4)),
            ...
            ('lump_sum_hours', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
            ...
            ('offer_letter_text', self.gf('django.db.models.fields.TextField')(null=True)),
            ('slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from=None, unique_with=())),
