...
DEFAULT_LETTER_NCH_INTRO = 'This is to confirm remuneration of work performed as a %(position)s ("Position") from %(start_date)s to %(end_date)s ("Term"). The remuneration will be $%(gross_hourly)s per hour plus 4 percent vacation pay. You must report your total work hours to your supervisor/delegate on a bi-weekly basis. This remuneration will be subject to all statutory income tax and benefit deductions. Any earnings paid by Canadian Sources are subject to the regulations set out by the Canada Revenue Agency (CRA). By law, deductions are taken from the salary for Canada Income Tax, Canada Pension Plan (CPP) and Employment Insurance (EI).\n\n'
DEFAULT_LETTER_NCBW_INTRO = 'This is to confirm remuneration of work performed as a %(position)s ("Position") from %(start_date)s to %(end_date)s ("Term"). The remuneration will be a biweekly payment of $%(biweekly_salary)s for a total amount of $%(total_pay)s. This remuneration will be subject to all statutory income tax and benefit deductions. Any earnings paid by Canadian Sources are subject to the regulations set out by the Canada Revenue Agency (CRA). By law, deductions are taken from the salary for Canada Income Tax, Canada Pension Plan (CPP) and Employment Insurance (EI).\n\n'
...
DEFAULT_LETTER_NCH = '\n\n'.join([
    ...
    """ \u2022 %(nc_duties)s""",
    """Your employment in the Position will automatically terminate at the end of the Term without requiring any further notice or payment""",
