...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'URLComponent.check'
        db.add_column('submission_urlcomponent', 'check', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'URLComponent.prefix'
        db.add_column('submission_urlcomponent', 'prefix', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'URLComponent.check'
        db.delete_column('submission_urlcomponent', 'check')

        # Deleting field 'URLComponent.prefix'
        db.delete_column('submission_urlcomponent', 'prefix')
