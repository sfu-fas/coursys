...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserArchive.grade_source'
        db.add_column(u'gpaconvert_userarchive', 'grade_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['gpaconvert.GradeSource']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserArchive.grade_source'
        db.delete_column(u'gpaconvert_userarchive', 'grade_source_id')
