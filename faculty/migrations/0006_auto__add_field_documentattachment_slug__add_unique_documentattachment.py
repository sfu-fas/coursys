...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentAttachment.slug'
        db.add_column(u'faculty_documentattachment', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='test', unique_with=(), max_length=50, populate_from='title'),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DocumentAttachment.slug'
        db.delete_column(u'faculty_documentattachment', 'slug')
