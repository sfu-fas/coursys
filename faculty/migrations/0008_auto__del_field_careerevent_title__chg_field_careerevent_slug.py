...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CareerEvent.title'
        db.delete_column(u'faculty_careerevent', 'title')


        # Changing field 'CareerEvent.slug'
        db.alter_column(u'faculty_careerevent', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=('person', 'unit'), max_length=50, populate_from='slug_string'))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CareerEvent.title'
        raise RuntimeError("Cannot reverse this migration. 'CareerEvent.title' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CareerEvent.title'
        db.add_column(u'faculty_careerevent', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)


        # Changing field 'CareerEvent.slug'
        db.alter_column(u'faculty_careerevent', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=('person', 'unit'), populate_from='full_title'))
