...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TempGrant.creator'
        db.add_column(u'faculty_tempgrant', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coredata.Person'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'TempGrant.created'
        db.add_column(u'faculty_tempgrant', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 28, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TempGrant.creator'
        db.delete_column(u'faculty_tempgrant', 'creator_id')

        # Deleting field 'TempGrant.created'
        db.delete_column(u'faculty_tempgrant', 'created')
