...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Memo', fields ['slug']
        db.delete_unique(u'faculty_memo', ['slug'])


        # Changing field 'Memo.slug'
        db.alter_column(u'faculty_memo', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=('career_event',), max_length=50, populate_from=None))

        # Changing field 'DocumentAttachment.slug'
        db.alter_column(u'faculty_documentattachment', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=('career_event',), max_length=50, populate_from='title'))
        # Adding field 'MemoTemplate.default_from'
        db.add_column(u'faculty_memotemplate', 'default_from',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'MemoTemplate', fields ['slug']
        db.create_unique(u'faculty_memotemplate', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'MemoTemplate', fields ['slug']
        db.delete_unique(u'faculty_memotemplate', ['slug'])


        # Changing field 'Memo.slug'
        db.alter_column(u'faculty_memo', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), unique=True, populate_from=None))
        # Adding unique constraint on 'Memo', fields ['slug']
        db.create_unique(u'faculty_memo', ['slug'])


        # Changing field 'DocumentAttachment.slug'
        db.alter_column(u'faculty_documentattachment', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from='title'))
        # Deleting field 'MemoTemplate.default_from'
        db.delete_column(u'faculty_memotemplate', 'default_from')
