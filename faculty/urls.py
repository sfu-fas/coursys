...
faculty_member_patterns = [ # prefix: /faculty/USERID_OR_EMPLID/
    ...
    url(r'^contact-info$', 'faculty.views.faculty_member_info', name='faculty_member_info'),
    url(r'^contact-info/edit$', 'faculty.views.edit_faculty_member_info', name='edit_faculty_member_info'),

    url(r'^teaching_credit_override/' + COURSE_SLUG + '$', 'faculty.views.teaching_credit_override', name='teaching_credit_override'),
...
faculty_patterns = [ # prefix: /faculty/
    ...
    # Event Searching
    url(r'^search/$', 'faculty.views.search_index', name='search_index'),
    url(r'^search/' + EVENT_TYPE + '$', 'faculty.views.search_events', name='search_events'),

    # Report: Salary
    url(r'^salaries$', 'faculty.views.salary_index', name='salary_index'),
    url(r'^salaries.csv$', 'faculty.views.salary_index_csv', name='salary_index_csv'),

    # Report: Fallout
    url(r'^fallout$', 'faculty.views.fallout_report', name='fallout_report'),
    url(r'^fallout.csv$', 'faculty.views.fallout_report_csv', name='fallout_report_csv'),

    # Report: Available Teaching Capacity
    url(r'^report/teaching_capacity$', 'faculty.views.teaching_capacity', name='teaching_capacity'),
    url(r'^report/teaching_capacity.csv$', 'faculty.views.teaching_capacity_csv', name='teaching_capacity_csv'),

    # Report: Courses + Instructor Accreditation
    url(r'^report/course_accreditation$', 'faculty.views.course_accreditation', name='course_accreditation'),
    ...
    # Positions
    url(r'^positions/$', 'faculty.views.list_positions', name='list_positions'),
    url(r'^positions/new_position$', 'faculty.views.new_position', name='new_position'),
    url(r'^positions/(?P<position_id>\d+)/edit_position/$', 'faculty.views.edit_position', name='edit_position'),
    url(r'^positions/(?P<position_id>\d+)/delete_position/$', 'faculty.views.delete_position', name='delete_position'),
    url(r'^positions/(?P<position_id>\d+)/view_position/$', 'faculty.views.view_position', name='view_position'),
    url(r'^positions/(?P<position_id>\d+)/assign_position_entry/$', 'faculty.views.assign_position_entry', name='assign_position_entry'),
    url(r'^positions/(?P<position_id>\d+)/assign_position_person/$', 'faculty.views.assign_position_person', name='assign_position_person'),
    url(r'^positions/(?P<position_id>\d+)/assign_position_futureperson/$', 'faculty.views.assign_position_futureperson', name='assign_position_futureperson'),
    url(r'^positions/(?P<position_id>\d+)/add_position_credentials/$', 'faculty.views.position_add_credentials', name='position_add_credentials'),
    url(r'^positions/(?P<position_id>\d+)/yellow1/$', 'faculty.views.position_get_yellow_form_tenure', name='position_get_yellow_form_tenure'),
    url(r'^positions/(?P<position_id>\d+)/yellow2/$', 'faculty.views.position_get_yellow_form_limited', name='position_get_yellow_form_limited'),
    url(r'^positions/(?P<position_id>\d+)/new_attach', 'faculty.views.new_position_attachment', name='new_position_attachment'),
    url(r'^positions/(?P<position_id>\d+)/' + ATTACH_SLUG + '/delete$', 'faculty.views.delete_position_attachment', name='delete_position_attachment'),
    url(r'^positions/(?P<position_id>\d+)/' + ATTACH_SLUG + '/view', 'faculty.views.view_position_attachment', name='view_position_attachment'),
    url(r'^positions/(?P<position_id>\d+)/' + ATTACH_SLUG + '/download$', 'faculty.views.download_position_attachment', name='download_position_attachment'),


    # Future Person Management
    url(r'^(?P<futureperson_id>\d+)/edit_futureperson/$', 'faculty.views.edit_futureperson', name='edit_futureperson'),
    url(r'^(?P<futureperson_id>\d+)/edit_futureperson/(?P<from_admin>\d)/$', 'faculty.views.edit_futureperson', name='edit_futureperson'),
    url(r'^(?P<futureperson_id>\d+)/view_futureperson/$', 'faculty.views.view_futureperson', name='view_futureperson'),
    url(r'^(?P<futureperson_id>\d+)/view_futureperson/(?P<from_admin>\d)/$', 'faculty.views.view_futureperson', name='view_futureperson'),
    url(r'^(?P<futureperson_id>\d+)/delete_futureperson/$', 'faculty.views.delete_futureperson', name='delete_futureperson')
]
