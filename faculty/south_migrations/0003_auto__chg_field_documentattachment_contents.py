...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DocumentAttachment.contents'
        db.alter_column(u'faculty_documentattachment', 'contents', self.gf('django.db.models.fields.files.FileField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'DocumentAttachment.contents'
        db.alter_column(u'faculty_documentattachment', 'contents', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        u'faculty.documentattachment': {
            ...
            'contents': ('django.db.models.fields.files.FileField', [], {'max_length': '500'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
