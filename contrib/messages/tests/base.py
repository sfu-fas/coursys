...
from contrib.messages import constants, utils
from contrib.messages.api import MessageFailure, get_level, set_level
from contrib.messages.storage import default_storage, base
from contrib.messages.storage.base import Message
...
class BaseTest(TestCase):
    ...
    urls = 'contrib.messages.tests.urls'
    levels = {
    ...
    def test_full_request_response_cycle(self):
        ...
        show_url = reverse('contrib.messages.tests.urls.show')
        for level in ('debug', 'info', 'success', 'warning', 'error'):
            add_url = reverse('contrib.messages.tests.urls.add',
                              args=(level,))
    ...
    def test_custom_tags(self):
        ...
        # contrib.messages.storage.base module, so after changing
