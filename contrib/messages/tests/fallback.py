from contrib.messages import constants
from contrib.messages.storage.fallback import FallbackStorage, \
    CookieStorage
from contrib.messages.tests.base import BaseTest
from contrib.messages.tests.cookie import set_cookie_data, \
    stored_cookie_messages_count
from contrib.messages.tests.session import set_session_data, \
