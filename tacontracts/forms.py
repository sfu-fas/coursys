...
class HiringSemesterForm(forms.ModelForm):
    ...
    tssu_link = forms.URLField(required=False, assume_scheme='https', label="Link to TSSU Collective Agreement", help_text="Link to TSSU Collective Agreement for Time Use Guidelines.")
