...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TACourse.member'
        db.add_column(u'tacontracts_tacourse', 'member',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='tacourse', null=True, to=orm['coredata.Member']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TACourse.member'
        db.delete_column(u'tacontracts_tacourse', 'member_id')
