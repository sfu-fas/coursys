...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TAContract.payperiods'
        db.alter_column(u'tacontracts_tacontract', 'payperiods', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

        # Changing field 'HiringSemester.payperiods'
        db.alter_column(u'tacontracts_hiringsemester', 'payperiods', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'TAContract.payperiods'
        db.alter_column(u'tacontracts_tacontract', 'payperiods', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'HiringSemester.payperiods'
        db.alter_column(u'tacontracts_hiringsemester', 'payperiods', self.gf('django.db.models.fields.PositiveIntegerField')())
