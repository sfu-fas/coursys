...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'GradStudent', fields ['campus']
        db.create_index('grad_gradstudent', ['campus'])

        # Adding index on 'GradStudent', fields ['current_status']
        db.create_index('grad_gradstudent', ['current_status'])


    def backwards(self, orm):
        # Removing index on 'GradStudent', fields ['current_status']
        db.delete_index('grad_gradstudent', ['current_status'])

        # Removing index on 'GradStudent', fields ['campus']
        db.delete_index('grad_gradstudent', ['campus'])
