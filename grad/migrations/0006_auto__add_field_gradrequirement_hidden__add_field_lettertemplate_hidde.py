...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GradRequirement.hidden'
        db.add_column('grad_gradrequirement', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'LetterTemplate.hidden'
        db.add_column('grad_lettertemplate', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ScholarshipType.hidden'
        db.add_column('grad_scholarshiptype', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GradRequirement.hidden'
        db.delete_column('grad_gradrequirement', 'hidden')

        # Deleting field 'LetterTemplate.hidden'
        db.delete_column('grad_lettertemplate', 'hidden')

        # Deleting field 'ScholarshipType.hidden'
        db.delete_column('grad_scholarshiptype', 'hidden')
