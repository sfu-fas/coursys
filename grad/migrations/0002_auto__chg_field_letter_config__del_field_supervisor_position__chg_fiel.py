...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('grad_letter', 'config', self.gf('jsonfield.fields.JSONField')())
        # Deleting field 'Supervisor.position'
        db.delete_column('grad_supervisor', 'position')


        # Changing field 'Supervisor.config'
        db.alter_column('grad_supervisor', 'config', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'SavedSearch.config'
        db.alter_column('grad_savedsearch', 'config', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'GradStudent.config'
        db.alter_column('grad_gradstudent', 'config', self.gf('jsonfield.fields.JSONField')())

    def backwards(self, orm):

        # Changing field 'Letter.config'
        db.alter_column('grad_letter', 'config', self.gf('jsonfield.JSONField')())
        # Adding field 'Supervisor.position'
        db.add_column('grad_supervisor', 'position',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)


        # Changing field 'Supervisor.config'
        db.alter_column('grad_supervisor', 'config', self.gf('jsonfield.JSONField')())

        # Changing field 'SavedSearch.config'
        db.alter_column('grad_savedsearch', 'config', self.gf('jsonfield.JSONField')())

        # Changing field 'GradStudent.config'
        db.alter_column('grad_gradstudent', 'config', self.gf('jsonfield.JSONField')())
