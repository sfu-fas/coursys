...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GradProgram.label'
        db.alter_column('grad_gradprogram', 'label', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'GradProgram.label'
        db.alter_column('grad_gradprogram', 'label', self.gf('django.db.models.fields.CharField')(max_length=10))
