...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GradStudent.application_status'
        db.delete_column('grad_gradstudent', 'application_status')


    def backwards(self, orm):
        # Adding field 'GradStudent.application_status'
        db.add_column('grad_gradstudent', 'application_status',
                      self.gf('django.db.models.fields.CharField')(default='UNKN', max_length=4),
                      keep_default=False)
