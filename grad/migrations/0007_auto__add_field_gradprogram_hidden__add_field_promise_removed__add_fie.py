...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GradProgram.hidden'
        db.add_column('grad_gradprogram', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Promise.removed'
        db.add_column('grad_promise', 'removed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'OtherFunding.removed'
        db.add_column('grad_otherfunding', 'removed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Scholarship.removed'
        db.add_column('grad_scholarship', 'removed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CompletedRequirement.removed'
        db.add_column('grad_completedrequirement', 'removed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GradProgram.hidden'
        db.delete_column('grad_gradprogram', 'hidden')

        # Deleting field 'Promise.removed'
        db.delete_column('grad_promise', 'removed')

        # Deleting field 'OtherFunding.removed'
        db.delete_column('grad_otherfunding', 'removed')

        # Deleting field 'Scholarship.removed'
        db.delete_column('grad_scholarship', 'removed')

        # Deleting field 'CompletedRequirement.removed'
        db.delete_column('grad_completedrequirement', 'removed')
    ...
    models = {
        ...
        'grad.gradstudent': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'current_status': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True'}),
