...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('grad_financialcomment', (
            ...
            ('comment_type', self.gf('django.db.models.fields.CharField')(max_length=3)),
        ...
        # Deleting field 'GradStudent.special_arrangements'
        db.delete_column('grad_gradstudent', 'special_arrangements')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'GradStudent.special_arrangements'
        db.add_column('grad_gradstudent', 'special_arrangements',
