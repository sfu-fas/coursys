...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GradStudent.current_status'
        db.add_column('grad_gradstudent', 'current_status',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GradStudent.current_status'
        db.delete_column('grad_gradstudent', 'current_status')
