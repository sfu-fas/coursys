...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExternalDocument'
        db.create_table(u'grad_externaldocument', (
        ...
        db.send_create_signal(u'grad', ['ExternalDocument'])


    def backwards(self, orm):
        # Deleting model 'ExternalDocument'
        db.delete_table(u'grad_externaldocument')
    ...
    models = {
        ...
        u'grad.externaldocument': {
            'Meta': {'object_name': 'ExternalDocument'},
