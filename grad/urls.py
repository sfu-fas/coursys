...
grad_patterns = [ # prefix /grad/
    ...
    url(r'^' + GRAD_SLUG + '/documents$', 'grad.views.manage_documents'),
    url(r'^' + GRAD_SLUG + '/documents/(?P<d_id>\d+)/remove$', 'grad.views.remove_document'),
    url(r'^' + GRAD_SLUG + '/documents/(?P<d_id>\d+)/download$', 'grad.views.download_file'),
