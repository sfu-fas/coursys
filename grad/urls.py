...
grad_patterns = [ # prefix /grad/
    ...
    url(r'^active/download$', grad_views.download_active_students, name='download_active_students'),
    ...
    url(r'^' + GRAD_SLUG + r'/supervisors/(?P<sup_id>\d+)/remove$', grad_views.remove_supervisor, name='remove_supervisor'),
    url(r'^' + GRAD_SLUG + '/status$', grad_views.manage_status, name='manage_status'),
    url(r'^' + GRAD_SLUG + r'/status/(?P<s_id>\d+)/remove$', grad_views.remove_status, name='remove_status'),
    url(r'^' + GRAD_SLUG + '/requirements$', grad_views.manage_requirements, name='manage_requirements'),
    url(r'^' + GRAD_SLUG + r'/requirements/(?P<cr_id>\d+)/remove$', grad_views.remove_completedrequirement, name='remove_completedrequirement'),
    url(r'^' + GRAD_SLUG + '/otherfunding$', grad_views.manage_otherfunding, name='manage_otherfunding'),
    url(r'^' + GRAD_SLUG + r'/otherfunding/(?P<o_id>\d+)/remove$', grad_views.remove_otherfunding, name='remove_otherfunding'),
    url(r'^' + GRAD_SLUG + '/financial$', grad_views.financials, name='financials'),
    url(r'^' + GRAD_SLUG + r'/financial-(?P<style>\w+)$', grad_views.financials, name='financials'),
    url(r'^' + GRAD_SLUG + '/financialcomments$', grad_views.manage_financialcomments, name='manage_financialcomments'),
    url(r'^' + GRAD_SLUG + r'/financialcomments/(?P<f_id>\d+)/remove$', grad_views.remove_financialcomment, name='remove_financialcomment'),
    url(r'^' + GRAD_SLUG + '/promises$', grad_views.manage_promises, name='manage_promises'),
    url(r'^' + GRAD_SLUG + r'/promises/(?P<p_id>\d+)/remove$', grad_views.remove_promise, name='remove_promise'),
    url(r'^' + GRAD_SLUG + '/progress_reports$', grad_views.manage_progress, name='manage_progress'),
    url(r'^' + GRAD_SLUG + r'/progress_reports/(?P<p_id>\d+)/remove$', grad_views.remove_progress, name='remove_progress'),
    url(r'^' + GRAD_SLUG + '/documents$', grad_views.manage_documents, name='manage_documents'),
    url(r'^' + GRAD_SLUG + r'/documents/(?P<d_id>\d+)/remove$', grad_views.remove_document, name='remove_document'),
    url(r'^' + GRAD_SLUG + r'/documents/(?P<d_id>\d+)/download$', grad_views.download_file, name='download_file'),
    url(r'^' + GRAD_SLUG + '/scholarship$', grad_views.manage_scholarships, name='manage_scholarships'),
    url(r'^' + GRAD_SLUG + r'/scholarship/(?P<s_id>\d+)/remove$', grad_views.remove_scholarship, name='remove_scholarship'),
