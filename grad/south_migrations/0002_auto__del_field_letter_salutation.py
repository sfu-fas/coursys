...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Letter.salutation'
        db.delete_column('grad_letter', 'salutation')


    def backwards(self, orm):
        # Adding field 'Letter.salutation'
        db.add_column('grad_letter', 'salutation',
                      self.gf('django.db.models.fields.CharField')(default='To whom it may concern', max_length=100, blank=True),
                      keep_default=False)
