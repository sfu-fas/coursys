    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(max_length=4, choices=[(b'AUTO', b'Automatic update'), (b'SYST', b'Automatic change by system'), (b'MAIL', b'Email notification sent'), (b'ADMN', b'Administrative action'), (b'FILL', b'User action')])),
