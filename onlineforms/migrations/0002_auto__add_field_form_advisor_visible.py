...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form.advisor_visible'
        db.add_column('onlineforms_form', 'advisor_visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form.advisor_visible'
        db.delete_column('onlineforms_form', 'advisor_visible')
