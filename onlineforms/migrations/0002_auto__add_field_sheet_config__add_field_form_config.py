...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sheet.config'
        db.add_column('onlineforms_sheet', 'config',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)

        # Adding field 'Form.config'
        db.add_column('onlineforms_form', 'config',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sheet.config'
        db.delete_column('onlineforms_sheet', 'config')

        # Deleting field 'Form.config'
        db.delete_column('onlineforms_form', 'config')
