...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SheetSubmission.config'
        db.add_column('onlineforms_sheetsubmission', 'config',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)

        # Adding unique constraint on 'FieldSubmissionFile', fields ['field_submission']
        db.create_unique('onlineforms_fieldsubmissionfile', ['field_submission_id'])

        # Adding field 'FormSubmission.config'
        db.add_column('onlineforms_formsubmission', 'config',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'FieldSubmissionFile', fields ['field_submission']
        db.delete_unique('onlineforms_fieldsubmissionfile', ['field_submission_id'])

        # Deleting field 'SheetSubmission.config'
        db.delete_column('onlineforms_sheetsubmission', 'config')

        # Deleting field 'FormSubmission.config'
        db.delete_column('onlineforms_formsubmission', 'config')
