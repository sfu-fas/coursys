...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Sheet', fields ['slug', 'form']
        db.create_unique('onlineforms_sheet', ['slug', 'form_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Sheet', fields ['slug', 'form']
        db.delete_unique('onlineforms_sheet', ['slug', 'form_id'])
