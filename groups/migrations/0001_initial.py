...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('groups_group', (
            ...
            ('groupForSemester', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique=False, unique_with=('courseoffering',), db_index=True)),
        ))
    ...
    models = {
        ...
        'groups.groupmember': {
            'Meta': {'unique_together': "(('student', 'activity'),)", 'object_name': 'GroupMember'},
