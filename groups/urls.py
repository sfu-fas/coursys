...
urlpatterns = patterns('',
	...
	url(r'^(?P<course_slug>' + COURSE_SLUG_RE + ')/create/$', 'groups.views.create'),
	url(r'^(?P<course_slug>' + COURSE_SLUG_RE + ')/create_result/$', 'groups.views.create_result'),
	url(r'^create/$', 'groups.views.create'),
    # url(r'^(?P<course_slug>' + COURSE_SLUG_RE + ')create_form/$','groups.views.create_form'),
